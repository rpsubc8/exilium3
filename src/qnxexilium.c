...
// set_palette(black_palette);
 ...
 if (pantallaVirtual != NULL){
  ...
  textout(pantallaVirtual,font,"**** COMOORDORE 64 JAVA V2 ****",38,25,azulFondo);
  textout(pantallaVirtual,font,"64G RAM SYSTEM  2 JAVA BYTES FREE",30,40,azulFondo);
  textout(pantallaVirtual,font,"READY.",22,55,azulFondo);
  ...
  textout(screen,font,"LOAD\".INTRO.JAVA\",8,1",22,70,azulFondo);
  while (crono<4);
  textout(screen,font,"READY.",22,85,azulFondo);// while (crono<4);
  while (crono<5);
  textout(screen,font,"RUN",22,95,azulFondo);// while (crono<5);
  while (crono<6);
  textout(screen,font,"LOADING DAEMON \"SPRITES\"",22,110,azulFondo);// while (crono<6);
  while (crono<7);
  textout(screen,font,"LOADING DAEMON \"VIRUS\"",22,120,azulFondo);// while (crono<7);
  while (crono<8);
  textout(screen,font,"LOADING DAEMON \"SOUND\"",22,130,azulFondo);// while (crono<8);
  while (crono<9);
  textout(screen,font,"VIRTUAL MACHINE ENABLED",22,140,azulFondo);// while (crono<10);
  while (crono<10);
  play_sample(datosIntro[SONIDO_CHIQUITO_NOPUEDESER].dat,255,127,1000,FALSE);
  textout(screen,font,"ERROR!! YOU DON'T HAVE ANY MEMORY",22,155,azulFondo);
  while (crono<11);
  textout(screen,font,"YOU NEED 128 GB OF RAM FREE",22,165,azulFondo);
  while(crono<13);
